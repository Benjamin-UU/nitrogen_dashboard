...
# Defines the div that includes a list of data sources, as well as a further reading list,
                        ...
                        children= [
                            html.Div(
                                children= [
                                    ...
                                    dcc.Markdown('''
                                        *These are only the sources for data used in the main analysis (nitrogen emissions, RLI, and LPI).  
                                        For a complete list of sources, please check the Github page.* 
                                        '''),
                                    html.Ul(
                                        children= [
                                            html.Li(
                                            ...
                                            html.Li(
                                                children= [
                                                    dcc.Link(
                                                        href= "https://github.com/Benjamin-UU/nitrogen_dashboard",
                                                        children= [
                                                            dcc.Markdown('''
                                    ...
                                    html.Ul(
                                        children= [
                                            ...
                                            html.Li(
                                                children= [
                                                    dcc.Link(
                                                        href= "https://www.louisbolk.nl/sites/default/files/publication/pdf/3005.pdf",
